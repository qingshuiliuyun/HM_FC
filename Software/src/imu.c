...
{		
	...
	if(ABS(ax)<18000 && ABS(ay)<18000 && ABS(az)<18000 )
	{	
		//把加计的三维向量转成单位向量。
		...
		if( 14000 < norm_acc && norm_acc < 18000 )
		{
			/* 叉乘得到误差 */
...
void simple_3d_trans(_xyz_f *ref, _xyz_f *in, _xyz_f *out) //小范围内正确。
{
	static s8 pn;
